                    ...
                    <div class="card-body">
                        ...
                        <b-form>
                            ...
                            <b-form-group
                                ...
                                label-cols-sm="3"
                            >
                                <b-form-input id="horizontal-phone-input" type="text" v-model="phone_number"></b-form-input>
                            </b-form-group>
                            ...
                            <b-form-group
                                ...
                                label-cols-sm="3"
                            >
                                <b-form-checkbox v-model="is_vip" switch class="mb-1">
                                </b-form-checkbox>
                            </b-form-group>
                            ...
                            <div class="form-group row justify-content-end">
                                <div class="col-sm-9">
                                    <div>
                                        <b-button variant="primary" v-on:click="updateGuest">Submit</b-button>
