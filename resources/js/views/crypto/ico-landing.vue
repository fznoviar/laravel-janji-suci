...
export default {
    ...
    computed: {
        dateDiff() {
            var now = new Date();
            var date2 = new Date(2020, 12, 31, 0, 0, 0);
                            ...
                            <div class="text-center">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="clearfix mt-4">
                                        <h5 class="float-right font-size-14">
                                            5234.43
                                        </h5>
                                    </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-sm-6">
                    <div class="blog-box mb-4 mb-xl-0">
                        <div class="position-relative">
                            ...
                            <div class="badge badge-success blog-badge font-size-11">
                                Cryptocurrency
                            </div>
                        </div>
                        ...
                        <div class="mt-4 text-muted">
                            <p class="mb-2">
                                <i class="bx bx-calendar mr-1"></i> 04 Mar,
                                2020
                            </p>
                            <h5 class="mb-3">
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="blog-box mb-4 mb-xl-0">
                        ...
                        <div class="mt-4 text-muted">
                            <p class="mb-2">
                                <i class="bx bx-calendar mr-1"></i> 12 Feb,
                                2020
                            </p>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="blog-box mb-4 mb-xl-0">
                        ...
                        <div class="mt-4 text-muted">
                            <p class="mb-2">
                                <i class="bx bx-calendar mr-1"></i> 06 Jan,
                                2020
                            </p>
                            <h5 class="mb-3">
                    ...
                    <div class="mb-4 mb-lg-0">
                        ...
                        <div class="blog-post">
                            <a href="#" class="post">
                                ...
                                <p class="mb-0">
                                    <i class="bx bx-calendar mr-1"></i> 04
                                    Mar, 2020
                                </p>
                            </a>
                            <a href="#" class="post">
                                ...
                                <p class="mb-0">
                                    <i class="bx bx-calendar mr-1"></i> 12
                                    Mar, 2020
                                </p>
                            </a>
                        </div>
