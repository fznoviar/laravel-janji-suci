...
Vue.component('guests', require("./apps/guests/index").default);
Vue.component('guests-create', require("./apps/guests/create").default);
Vue.component('guests-edit', require("./apps/guests/edit").default);
...
Vue.component(
    "auth-register-1",
    require("./sample-pages/register-sample").default
);
Vue.component(
    "auth-recoverpw",
    require("./sample-pages/recoverpw-sample").default
);
